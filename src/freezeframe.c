...
freezeframe_hide_surface(struct scran_output *st_output)
{
    ...
    freezeframe->showing = false;
    {
        ...
        scran_ui_textline_item_set_text(ui_ctx, &ui_ctx->ui_statusline_keymap, SCRAN_UI_STATUSLINE_KEYMAP_ITEM_I_FREEZEFRAME, SCRAN_UI_TEXT_STATUSLINE_KEYMAP_FREEZEFRAME_TURN_ON);
        scran_ui_textline_item_set_color(ui_ctx, &ui_ctx->ui_statusline_keymap, SCRAN_UI_STATUSLINE_KEYMAP_ITEM_I_FREEZEFRAME, SCRAN_UI_COLOR_DEFAULT);
