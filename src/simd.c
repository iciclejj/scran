...
// static void
// transform_framebuffer_sse41_rotate_270__aligned(
//     const void *const restrict src_aligned,
//     const int src_width_px_padded_aligned,
//     const int src_height_px_padded_aligned,
//     const int src_stride_bytes,
//     void *const restrict dst,
//     const int dst_stride_bytes,
//     __m128i rgba32_shuffle_mask_128 // Mask for _mm_shuffle_epi8
// ) {
//     // TODO: Prefetch? Tiling? Seems to end up neutral or worse from naive implementation.
//
//     for (int src_row_px = 0; src_row_px < src_height_px_padded_aligned; src_row_px += 4) {
//         assert(src_row_px + 3 < src_height_px_padded_aligned); // Stay within padded bounds
//
//         const char *const _src_block_addrs_row_base = (char *)src_aligned + src_row_px * src_stride_bytes;
//
//         // XXX: Specific to 270 and 90
//         const int dst_col_px = src_row_px;
//         const int dst_col_offset_bytes = dst_col_px * RGBA32_PIXEL_STRIDE;
//
//         for (int src_col_px = 0; src_col_px < src_width_px_padded_aligned; src_col_px += 4) {
//             assert(src_col_px + 3 < src_width_px_padded_aligned); // Stay within padded bounds
//
//             const char *const _src_block_row_addr_0 = _src_block_addrs_row_base + src_col_px * RGBA32_PIXEL_STRIDE;
//             __m128i *src_block_row_addrs_0 = (__m128i *)(_src_block_row_addr_0);
//             __m128i *src_block_row_addrs_1 = (__m128i *)(_src_block_row_addr_0 + 1 * src_stride_bytes);
//             __m128i *src_block_row_addrs_2 = (__m128i *)(_src_block_row_addr_0 + 2 * src_stride_bytes);
//             __m128i *src_block_row_addrs_3 = (__m128i *)(_src_block_row_addr_0 + 3 * src_stride_bytes);
//
//             // Load
//             __m128i src_block_rows_0 = _mm_load_si128(src_block_row_addrs_0);
//             __m128i src_block_rows_1 = _mm_load_si128(src_block_row_addrs_1);
//             __m128i src_block_rows_2 = _mm_load_si128(src_block_row_addrs_2);
//             __m128i src_block_rows_3 = _mm_load_si128(src_block_row_addrs_3);
//
//             // Convert pixel format
//             src_block_rows_0 = _mm_shuffle_epi8(src_block_rows_0, rgba32_shuffle_mask_128);
//             src_block_rows_1 = _mm_shuffle_epi8(src_block_rows_1, rgba32_shuffle_mask_128);
//             src_block_rows_2 = _mm_shuffle_epi8(src_block_rows_2, rgba32_shuffle_mask_128);
//             src_block_rows_3 = _mm_shuffle_epi8(src_block_rows_3, rgba32_shuffle_mask_128);
//
//             // Store
//             {
//                 // XXX NOTE: This could be its own function, using a
//                 // function pointer depending on desired rotation, but makes
//                 // optimizing more difficult.
//
//                 const int dst_row_px = (src_width_px_padded_aligned - 4) - src_col_px; // -4 => len -> index
//
//                 // Transpose/rotate
//                 const __m128i _dst_row_3lo_2lo = _mm_unpacklo_epi32(src_block_rows_0, src_block_rows_1);
//                 const __m128i _dst_row_3hi_2hi = _mm_unpacklo_epi32(src_block_rows_2, src_block_rows_3);
//                 const __m128i _dst_row_1lo_0lo = _mm_unpackhi_epi32(src_block_rows_0, src_block_rows_1);
//                 const __m128i _dst_row_1hi_0hi = _mm_unpackhi_epi32(src_block_rows_2, src_block_rows_3);
//                 const __m128i dst_block_row_3 = _mm_unpacklo_epi64(_dst_row_3lo_2lo, _dst_row_3hi_2hi);
//                 const __m128i dst_block_row_2 = _mm_unpackhi_epi64(_dst_row_3lo_2lo, _dst_row_3hi_2hi);
//                 const __m128i dst_block_row_1 = _mm_unpacklo_epi64(_dst_row_1lo_0lo, _dst_row_1hi_0hi);
//                 const __m128i dst_block_row_0 = _mm_unpackhi_epi64(_dst_row_1lo_0lo, _dst_row_1hi_0hi);
//
//                 __m128i *const dst_row_0_addr = (__m128i *)((char *)dst + (dst_row_px + 0) * dst_stride_bytes + dst_col_offset_bytes);
//                 __m128i *const dst_row_1_addr = (__m128i *)((char *)dst_row_0_addr + 1 * dst_stride_bytes);
//                 __m128i *const dst_row_2_addr = (__m128i *)((char *)dst_row_0_addr + 2 * dst_stride_bytes);
//                 __m128i *const dst_row_3_addr = (__m128i *)((char *)dst_row_0_addr + 3 * dst_stride_bytes);
//
//                 assert((uintptr_t)dst_row_0_addr % 16 == 0);
//                 assert((uintptr_t)dst_row_1_addr % 16 == 0);
//                 assert((uintptr_t)dst_row_2_addr % 16 == 0);
//                 assert((uintptr_t)dst_row_3_addr % 16 == 0);
//
//                 _mm_store_si128((__m128i *)dst_row_0_addr, dst_block_row_0);
//                 _mm_store_si128(dst_row_1_addr, dst_block_row_1);
//                 _mm_store_si128(dst_row_2_addr, dst_block_row_2);
//                 _mm_store_si128(dst_row_3_addr, dst_block_row_3);
//             }
//         }
//     }
// }
...
//
// static void
// _transform_framebuffer_sse41__aligned(
//     const void *src,
//     void *dst,
//     int src_width_px,
//     int src_height_px,
...
//     const __m128i rgba_shuffle_mask_128 = _mm_add_epi8(_rgba_shuffle_mask_128_offsets, _rgba_shuffle_mask_128);
//
//     assert((uintptr_t)dst % SSE_ALIGNMENT_BYTES == 0);
//     const void *const src_aligned = _floor_align_pointer_sse41(src);
//
//     const int src_width_px_padded_aligned = _pad_align_src_width_px_sse41(src_width_px, RGBA32_PIXEL_STRIDE, src, src_aligned);
//     const int src_height_px_padded_aligned = _pad_align_src_height_px_sse41(src_height_px, RGBA32_PIXEL_STRIDE);
//
//     assert(src_width_px_padded_aligned * RGBA32_PIXEL_STRIDE <= src_stride_bytes);
//     const int _dst_stride_px = get_transformed_width(src_width_px_padded_aligned, src_height_px_padded_aligned, transform);
//     const int dst_stride_bytes = RGBA32_PIXEL_STRIDE * _dst_stride_px;
//     *dst_stride = dst_stride_bytes;
//     { // XXX TODO: This should only be used when 270 (and 90?) rotate (?)
//         // TODO: Make macros or functions for the masks
//         const ptrdiff_t src_width_bytes_left_padding = ((char *)src - (char *)src_aligned);
//         assert(src_width_bytes_left_padding % rgba32_pixel_stride == 0);
//         const size_t src_width_px_left_padding = src_width_bytes_left_padding / RGBA32_PIXEL_STRIDE;
//         const size_t src_width_px_right_padding = src_width_px_padded_aligned - src_width_px - src_width_px_left_padding;
//         void *const dst_aligned_to_src = (char *)dst + (src_width_px_right_padding * dst_stride_bytes);
//         *dst_with_offset = dst_aligned_to_src;
//     }
//
//     switch (transform) {
//         case WL_OUTPUT_TRANSFORM_270:
//         case WL_OUTPUT_TRANSFORM_90: // XXX TEST
//             transform_framebuffer_sse41_rotate_270__aligned(
//                 src_aligned,
//                 src_width_px_padded_aligned,
//                 src_height_px_padded_aligned,
//                 src_stride_bytes,
//                 dst,
//                 dst_stride_bytes,
//                 rgba_shuffle_mask_128
