...
#define SCRANROT_YUV420_KERNEL_TARGET SCRANROT_TARGET_SSSE3
#include "kernel.ipp"
#undef SCRANROT_YUV420_KERNEL_TARGET


bool
scranrot::internal::transform_framebuffer_to_yuv420_ssse3(
    ...
    case SCRANROT_TRANSFORM_270:
        transform_fn = transform_framebuffer_to_yuv420__kernel<YUV420BackendSSSE3, Rotate270>; break;
    case SCRANROT_TRANSFORM_180:
        transform_fn = transform_framebuffer_to_yuv420__kernel<YUV420BackendSSSE3, Rotate180>; break;
    case SCRANROT_TRANSFORM_90:
        transform_fn = transform_framebuffer_to_yuv420__kernel<YUV420BackendSSSE3, Rotate90> ; break;
    case SCRANROT_TRANSFORM_NORMAL:
        transform_fn = transform_framebuffer_to_yuv420__kernel<YUV420BackendSSSE3, Rotate0>  ; break;
    default:
