...
extern struct wp_presentation_feedback_listener          presentation_feedback_listener__selection_transparent_for_fullscreen_capture;
...
void keyboard_listener__destroy(struct scran_seat *st_seat);
